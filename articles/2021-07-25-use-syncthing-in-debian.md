...
Debian GNU/Linuxの次のリリースである、Bullseyeにおいて、Dropboxなどのようにファイル同期をおこなうsyncthingというソフトウェアを用いてファイル同期をおこなう。
実例として、現在私が使っている、CLIでのタスク管理と時間管理をおこなう、taskwarriorとtimewarriorを事例する記事です。
