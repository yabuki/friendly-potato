...
設定をしていなかったためか、`rm -rf ~/.amp/`でアンインストールができたように見える。

## 参考文献

- [Owner’s Manual - Amp](https://ampcode.com/manual#get-started)
- [Amp Free Is Full (For Now) - Amp](https://ampcode.com/news/amp-free-is-full-for-now)

- [Amp Free - 広告で無料利用できる AI コーディングエージェント](https://zenn.dev/katsuhisa_/articles/ampcode-free-frontier-guide)
